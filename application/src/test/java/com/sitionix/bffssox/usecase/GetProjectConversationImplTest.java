...
class GetProjectConversationImplTest {
    ...
    private GetProjectConversation getProjectConversation;
    ...
    @BeforeEach
    void setUp() {
        this.getProjectConversation = new GetProjectConversationImpl(this.agentConversationClient);
    }
    ...
    @Test
    void givenProjectIdAndConversationId_whenExecute_thenReturnProjectConversationDetails() {
        //given
        ...
        when(this.agentConversationClient.getProjectConversation(projectId, conversationId)).thenReturn(response);
        ...
        verify(this.agentConversationClient).getProjectConversation(projectId, conversationId);
    }
}
